...
- Strategies carry a `beacon` number: a Roman numeral + named color (`js/Beacon.js`) used only as a visual/spoken reference. Numbers are stable (lowest free number on creation); the 10 colors cycle after X.
